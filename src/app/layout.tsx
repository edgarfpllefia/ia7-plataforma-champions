  ...
  return (
    <html lang="es">
      <body className={`${bebas.variable} ${dmSans.variable} antialiased bg-[#06080f] text-white min-h-screen font-dm`}>
        ...
        <nav className="relative z-50 border-b border-white/6 bg-[#06080f]/80 backdrop-blur-xl sticky top-0">
          <div className="container mx-auto max-w-7xl px-5 flex items-center justify-between h-[60px]">
            ...
            <div className="flex items-center gap-2">
              <Link href="/login" className="text-[13px] font-medium text-gray-500 hover:text-white px-3 py-1.5 rounded-lg hover:bg-white/5 transition-all">
                Entrar
              </Link>
              <Link href="/register" className="text-[13px] font-semibold bg-blue-600 hover:bg-blue-500 px-4 py-1.5 rounded-lg transition-colors">
                Registro
              </Link>
            </div>
          </div>
